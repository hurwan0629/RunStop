...
러닝을 시작하거나 꾸준히 이어가기 어려운 사용자가 자신의 목표와 선호에 맞는 코스를 쉽게 찾고, 일상에서 능동적으로 러닝을 즐길 수 있도록 돕습니다.
...
<object data="./assets/RUNSTOP%20발표%20자료.pdf" type="application/pdf" width="100%" height="600">
  <p>아래 링크에서 발표 자료를 확인할 수 있습니다.</p>
</object>

[📎 RunStop 발표 자료 PDF 열기](./assets/RUNSTOP%20발표%20자료.pdf)
